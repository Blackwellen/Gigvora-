// Canonical, full ISO 3166-1 country reference — the single source of truth
// for any country picker/filter across the platform. Every domain that has
// a "location" column today (profiles, jobs, gigs, groups, videos,
// contacts, and Domain 18's pm_projects) stores it as an unconstrained
// free-text string with nothing shared backing it; this is that shared
// list, served over the API (apps/web has no way to import a backend
// package directly — see modules/taxonomies) rather than duplicated as a
// second copy in the frontend bundle.
export const COUNTRIES = [
  ...
  { code: 'CG', name: 'Congo (Congo-Brazzaville)', region: 'Africa' },
  ...
  { code: 'HK', name: 'Hong Kong SAR', region: 'Asia' },
  ...
  { code: 'MO', name: 'Macao SAR', region: 'Asia' },
...
export function countryName(code) {
  return COUNTRY_BY_CODE[String(code).toUpperCase()]?.name || null;
}
