        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true">
          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-floating">
            ...
            {status === 'success' ? (
              ...
              <>
                <h3 className="text-lg font-bold text-ink-900">Speak to sales</h3>
                <p className="mt-1 text-sm text-ink-500">Tell us about your hiring needs and we&rsquo;ll be in touch.</p>
                ...
                <form onSubmit={handleSubmit} className="mt-5 space-y-3">
                  ...
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-ink-700">How many hires per quarter?</label>
                    <textarea
                      value={form.message}
