...
export function BookDemoModal({
  ...
  return (
    <>
      <Button type="button" variant="outline" size="lg" className={triggerClassName} onClick={() => setOpen(true)}>
        {triggerLabel}
      </Button>
            ...
            {status === 'success' ? (
              <div className="py-4 text-center">
                ...
                <p className="mt-1 text-sm text-ink-500">
                  Thanks, {form.name.split(' ')[0] || 'there'} — a member of our team will reach out shortly.
                </p>
                <Button
                  type="button"
              ...
              <>
                <h3 className="text-lg font-bold text-ink-900">Book a demo</h3>
                <p className="mt-1 text-sm text-ink-500">Tell us about your sales team and we&rsquo;ll be in touch.</p>
                ...
                <form onSubmit={handleSubmit} className="mt-5 space-y-3">
                  ...
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-ink-700">What's your sales team size?</label>
                    <textarea
                      value={form.message}
