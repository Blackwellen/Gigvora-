            ...
            {status === 'success' ? (
              <div className="py-4 text-center">
                ...
                <p className="mt-1 text-sm text-ink-500">
                  Thanks, {form.name.split(' ')[0] || 'there'} — a member of our team will reach out shortly to schedule your
                  demo.
                </p>
                <Button
                  type="button"
              ...
              <>
                <h3 className="text-lg font-bold text-ink-900">Talk to sales</h3>
                <p className="mt-1 text-sm text-ink-500">Tell us a bit about your team and we&rsquo;ll be in touch.</p>
                ...
                <form onSubmit={handleSubmit} className="mt-5 space-y-3">
                  ...
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-ink-700">What are you hoping to solve?</label>
                    <textarea
                      value={form.message}
  ...
  return (
    <div>
      ...
      <input
        ...
        className={cn(
          'w-full rounded-lg border border-ink-200 px-3 py-2 text-sm text-ink-900 outline-none placeholder:text-ink-400 focus:border-brand-400'
        )}
      />
    </div>
  );
