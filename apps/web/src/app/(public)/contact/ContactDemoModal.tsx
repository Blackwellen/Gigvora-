...
// Local demo-request modal for the Contact page ("Book a personalized demo"
// card). Mirrors the for-businesses BookDemoModal pattern but is kept local
// to this route so pages built concurrently never share mutable files.
export function ContactDemoModal({ open, onClose, product = 'general' }: { open: boolean; onClose: () => void; product?: string }) {
  ...
  return (
    <Modal open={open} onClose={handleClose} labelledBy="book-demo-title" className="max-w-lg">
      <ModalHeader title="Book a personalized demo" onClose={handleClose} />
        ...
        {status === 'success' ? (
          <div className="flex flex-col items-center py-6 text-center">
            ...
            <p className="mt-1 text-sm text-ink-500">
              Thanks, {form.name.split(' ')[0] || 'there'}. Our team will reach out within one business day to schedule
